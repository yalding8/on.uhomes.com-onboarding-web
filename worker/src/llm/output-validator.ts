...
> = {
  ...
  // ── 以下字段来自 field-definitions.ts，之前被静默丢弃 ──
  commission_short_term: "string",
  commission_renewals: "string",
  accounting_contact: "string",
  emergency_contact: "string",
  availability_method: "string[]",
  instant_booking: "string",
  referral_tracking_method: "string[]",
  uhomes_hear_about_us: "string",
  cancel_before_movein: "string",
  lease_transfer_options: "string[]",
  intl_required_docs: "string",
  i20_accepted: "string",
  alternative_income_docs: "string[]",
  guarantor_options: "string[]",
  local_required_docs: "string",
  income_verification: "string",
  application_fee: "number",
  admin_fee: "number",
  deposit_intl: "string",
  deposit_refund_process: "string",
  parking_fee: "string",
  pet_fee: "string",
  pet_rent: "number",
  other_premiums: "string",
  room_transfer_policy: "string",
  renters_insurance: "string",

      ...
      <nav className="w-full border-b border-[var(--color-border)] bg-[var(--color-bg-primary)]/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="font-bold text-lg tracking-tight text-[var(--color-primary)]">
            uhomes.com
            <span className="text-[var(--color-text-primary)] ml-2">Partners</span>
          </div>
        ...
        <div className="max-w-2xl">
          ...
          <div className="space-y-6">
            <div className="flex items-start">
              ...
              <div className="ml-4">
                <h4 className="text-base font-semibold text-[var(--color-text-primary)]">Automated Onboarding</h4>
                <p className="mt-1 text-sm text-[var(--color-text-secondary)]">Sign the contract and our AI automatically extracts your building inventory directly from your website.</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4">
                <h4 className="text-base font-semibold text-[var(--color-text-primary)]">Unrivaled Distribution</h4>
                <p className="mt-1 text-sm text-[var(--color-text-secondary)]">Your rooms are instantly distributed across all uhomes platforms and leading partner networks globally.</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4">
                <h4 className="text-base font-semibold text-[var(--color-text-primary)]">Secure & Managed</h4>
                <p className="mt-1 text-sm text-[var(--color-text-secondary)]">Every lead undergoes screening. Access a centralized dashboard to track real-time bookings.</p>
              </div>
            </div>
          </div>
        </div>

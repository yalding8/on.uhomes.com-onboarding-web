    ...
    <LegalLayout currentPage="privacy">
      ...
      <Section title="4. Information Sharing and Disclosure">
        ...
        <ul className="list-disc pl-5 space-y-1 mt-2">
          ...
          <li>
            <strong>Platform users:</strong> property information you submit may
      ...
      <Section title="5. Data Security">
        <p>
          ...
          in transit (TLS), secure authentication (OTP-based), and row-level
          security policies to protect your data. However, no method of
      ...
      <Section title="8. International Data Transfers">
        ...
        <p>
          ...
          Special Administrative Region. Where we transfer data outside of Hong
          Kong, we ensure that adequate protections are in place as required by

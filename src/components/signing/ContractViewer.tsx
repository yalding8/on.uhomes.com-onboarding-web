          ...
          <div className="max-w-xl mx-auto text-center space-y-6">
            <div className="p-6 bg-[var(--color-bg-secondary)] rounded-xl border border-[var(--color-border)]">
              ...
              <p className="text-[var(--color-text-secondary)] text-sm mb-6">
                Your partnership agreement has been generated by the uhomes BD
                team. Please review the terms and complete the electronic
                signature to activate your account.
              </p>
            ...
            <p className="text-xs text-[var(--color-text-secondary)]">
              By clicking &quot;Sign Contract&quot;, you agree to the Terms of
              Service and Privacy Policy. The electronic signature is legally
              binding.
            </p>
          </div>
        ) : (

...
export const ALL_CATEGORIES: FieldCategory[] = [
  'basic_info', 'commission', 'contacts', 'availability',
  'booking_process', 'lease_policy', 'tenant_qualification',
  'building_details', 'fees', 'furnishing_room',
];

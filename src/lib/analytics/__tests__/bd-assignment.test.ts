...
const TERRITORIES: BDTerritory[] = [
  { bd_user_id: "bd_toronto", country_code: "CA", city: "Toronto", active_count: 5, is_active: true, priority: 0, referral_code: null },
  { bd_user_id: "bd_ca_1", country_code: "CA", city: null, active_count: 10, is_active: true, priority: 0, referral_code: null },
  { bd_user_id: "bd_ca_2", country_code: "CA", city: null, active_count: 3, is_active: true, priority: 0, referral_code: null },
  { bd_user_id: "bd_au", country_code: "AU", city: null, active_count: 8, is_active: true, priority: 0, referral_code: null },
  { bd_user_id: "bd_global_1", country_code: null, city: null, active_count: 20, is_active: true, priority: 0, referral_code: null },
  { bd_user_id: "bd_global_2", country_code: null, city: null, active_count: 2, is_active: true, priority: 0, referral_code: null },
  { bd_user_id: "bd_ref_001", country_code: "US", city: null, active_count: 15, is_active: true, priority: 0, referral_code: "REF001" },
  { bd_user_id: "bd_paused", country_code: "CA", city: "Vancouver", active_count: 0, is_active: false, priority: -1, referral_code: null },
];
